...
public class maingame {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        //Ahora creamos el tablero. Recordamos: no deja de ser un panel un poquito "especial"
        ...
        //Le damos un enlace al tablero para que sepa quién es su frame (ventana) y así sepa
		...
		while (true) {  //por siempre jamás (hasta que nos cierren la ventana) estamos controlando el juego.
			...
			if (frame.mostrarFin()) {				
				   JOptionPane.showMessageDialog(frame, "Se acabo vaquero, has conseguido " + puntosNum.getText() + " puntos");					
			}	
